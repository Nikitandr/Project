...
class MyWidget(QMainWindow, Ui_MainWindow):
    ...
    def drawFlag(self, qp):
        qp.setBrush(QColor(189, 183, 107))
        qp.drawRect(170, 0, 120, 30)
        qp.setBrush(QColor(255, 140, 0))
        qp.drawRect(170, 30, 120, 30)
    ...
    def line1place1(self):
        if self.flag_line1_place1:
            ...
            self.totals.setText('Итого: {} руб'.format(self.total))
        else:
            self.line1_place1.setStyleSheet("background-color: #BDB76B")
            self.flag_line1_place1 = True
            self.ticket -= 1
    ...
    def bought(self):
        ...
        self.tickets.setText('Билетов: {}'.format(self.ticket))
        self.totals.setText('Итого: {} руб'.format(self.total))
        self.bans.setText('Мест забранировано: {}'.format(self.ban))
        self.frees.setText('Мест свободно: {}'.format(self.free))
